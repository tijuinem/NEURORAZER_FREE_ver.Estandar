...
void bicis_a_mostrar (int bicis_a_mostrar_pantalla)
{
  ...
  {  
    ...
    color_para_posicionarx11 =  getpixel (fondo1, x_aleatorio_bici_extra , y_aleatorio_bici_extra);
    color_para_posicionarx22 =  getpixel (fondo1, x_aleatorio_bici_extra + size_bici_extra_x, y_aleatorio_bici_extra);                          
    color_para_posicionarx33 =  getpixel (fondo1, x_aleatorio_bici_extra , y_aleatorio_bici_extra + size_bici_extra_y);                          
    color_para_posicionarx44 =  getpixel (fondo1, x_aleatorio_bici_extra + size_bici_extra_x, y_aleatorio_bici_extra + size_bici_extra_y);                          
    color_para_posicionarx55 =  getpixel (fondo1, x_aleatorio_bici_extra + size_bici_extra_x/2, y_aleatorio_bici_extra + size_bici_extra_y/2);     }   while 
          ((color_para_posicionarx11 !=0000) && 
          ( color_para_posicionarx22 !=0000) && 
          ( color_para_posicionarx33 !=0000) && 
          ( color_para_posicionarx44 !=0000) &&       
          ( color_para_posicionarx55 !=0000));            
